...
const Passions = (props) => {
    return (
        <section>
            ...
            <div className="text-gray-200 px-20 text-center text-xl">All these technologies are something I find extremely interesting. Have really only taken a full dive into full stack devlopment but I am excited to start the journey into Machine Learning and Game Devlopment</div>
        </section>
    )
}
