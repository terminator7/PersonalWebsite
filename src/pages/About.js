...
const AboutMe = (props) => {
    return (
        <section id='about'>
            ...
            <div className="aboutMeContainer flex justify-center">
                <div className="greetingSection text-gray-200 flex mx-5 md:border rounded-md flex-col md:flex-row xl:w-3/4">
                    <div className="imageContainer md:w-1/2 p-10 flex justify-center items-center">
                    ...
                    <div className="md:w-1/2 flex flex-col items-center md:p-6 text-xl md:px-2 text-center px-10">
